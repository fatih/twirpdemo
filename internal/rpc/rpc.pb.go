...
func (x *MulResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MulResp) ProtoMessage() {}

func (x *MulResp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_rpc_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MulResp.ProtoReflect.Descriptor instead.
func (*MulResp) Descriptor() ([]byte, []int) {
	return file_proto_rpc_proto_rawDescGZIP(), []int{1}
}

func (x *MulResp) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_proto_rpc_proto_rawDesc = []byte{
	...
	,
...
var file_proto_rpc_proto_goTypes = []interface{}{
	(*MulReq)(nil),  // 0: MulReq
	(*MulResp)(nil), // 1: MulResp
	(*AddReq)(nil),  // 2: AddReq
	(*AddResp)(nil), // 3: AddResp
}
var file_proto_rpc_proto_depIdxs = []int32{
	0, // 0: Calculator.Mul:input_type -> MulReq
	2, // 1: Calculator.Add:input_type -> AddReq
	1, // 2: Calculator.Mul:output_type -> MulResp
	3, // 3: Calculator.Add:output_type -> AddResp
